...
public abstract class BaseActivity extends Activity {
     ...
     * should go: calling {@link android.app.Activity#setContentView(int)} to
     * inflate the activity's UI, using {@link android.app.Activity#findViewById}
     * to programmatically interact with widgets in the UI, calling {@link
     * android.app.Activity#managedQuery(android.net.Uri, String[], String,
     * String[], String)} to retrieve cursors for data being displayed, etc.
     *
     * <p>You can call {@link android.app.Activity#finish} from within this
     * function, in
     * which case onDestroy() will be immediately called after {@link
     * android.app.Activity#onCreate} without any of the rest of the activity
     * lifecycle ({@link android.app.Activity#onStart}, {@link
     * android.app.Activity#onResume}, {@link android.app.Activity#onPause},
     * etc) executing.
     *
