...
public abstract class BaseFragmentActivity extends FragmentActivity {
     ...
     * should go: calling {@link FragmentActivity#setContentView(int)} to
     * inflate the activity's UI, using {@link FragmentActivity#findViewById} to
     * programmatically interact with widgets in the UI, calling {@link
     * FragmentActivity#managedQuery(android.net.Uri, String[], String,
     * String[], String)} to retrieve cursors for data being displayed, etc.
     *
     * <p>You can call {@link FragmentActivity#finish} from within this
     * function, in
     * which case onDestroy() will be immediately called after {@link
     * FragmentActivity#onCreate} without any of the rest of the activity
     * lifecycle ({@link FragmentActivity#onStart}, {@link
     * FragmentActivity#onResume}, {@link FragmentActivity#onPause}, etc)
     * executing.
     *
     ...
     * @see FragmentActivity#onRestoreInstanceState
